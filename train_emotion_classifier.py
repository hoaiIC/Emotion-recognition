...
from models.cnn import mini_XCEPTION, plot_model_history, simple_CNN, vgg16, cnn, simpler_CNN
...
model_hist = model.fit_generator(data_generator.flow(xtrain, ytrain,
                                            batch_size),
